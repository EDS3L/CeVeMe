...
public final class EmailTemplates {
    ...
    public static String passwordResetEmailHtml(String resetLink) {
        return passwordResetEmailHtml(
                resetLink,
                "#1B64F2",
                "#111827",
                "#F9FAFB"
    ...
    public static String passwordResetEmailHtml(String resetLink,
        ...
        return "<!doctype html>" +
                ...
                "  <meta charset=\"utf-8\">" +
                "  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">" +
                "  <title>Zmiana hasła – " + safeBrand + "</title>" +
                "</head>" +
                "<body style=\"margin:0;padding:0;background:" + background + ";\">" +
                "  <div style=\"display:none;visibility:hidden;opacity:0;height:0;max-height:0;overflow:hidden;mso-hide:all;\">" +
                "    Link do zmiany hasła w " + safeBrand + " wygasa po 15 minutach." +
                "  </div>" +
                ...
                "              <p style=\"margin:0 0 18px 0;font:400 15px/1.7 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;color:#4B5563;\">" +
                "                Otrzymaliśmy prośbę o zmianę hasła do konta w <strong style=\"color:" + textColor + ";\">" + safeBrand + "</strong>. " +
                "                Kliknij przycisk poniżej, aby ustawić nowe hasło." +
                "              </p>" +

                "              <table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" style=\"margin:18px 0 8px 0;\">" +
                "                <tr>" +
                "                  <td align=\"center\" style=\"border-radius:10px;background:" + primaryColor + ";\">" +
                "                    <a href=\"" + safeLink + "\" target=\"_blank\" rel=\"noopener noreferrer\" " +
                "                       style=\"display:inline-block;padding:12px 20px;font:600 14px/1.2 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;color:#ffffff;text-decoration:none;\">" +
                "                      Ustaw nowe hasło" +
                "                    </a>" +
                "                  </td>" +
                "                </tr>" +
                ...
                "              <p style=\"margin:0 0 22px 0;font:400 14px/1.8 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;color:#6B7280;\">" +
                "                Link jest jednorazowy i wygasa po <strong>15 minutach</strong>. " +
                "                Jeśli to nie Ty inicjowałeś/aś tę operację, zignoruj tę wiadomość." +
                "              </p>" +
                "              <table role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"margin:0 0 24px 0;\">" +
                "                <tr>" +
                "                  <td style=\"padding:12px;border:1px solid #E5E7EB;border-radius:12px;background:#FAFAFA;\">" +
                "                    <p style=\"margin:0;font:400 12px/1.6 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;color:#6B7280;\">" +
                "                      Jeśli przycisk nie działa, skopiuj i wklej ten adres w przeglądarce:<br>" +
                "                      <a href=\"" + safeLink + "\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"word-break:break-all;color:" + primaryColor + ";text-decoration:underline;\">" +
                "                        " + safeLink +
                "                      </a>" +
                "                    </p>" +
                "                  </td>" +
                ...
                "              </p>" +
                "              <p style=\"margin:0 0 28px 0;font:400 12px/1.7 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Arial,sans-serif;color:#9CA3AF;\">" +
                "                Jeśli nie prosiłeś/aś o zmianę hasła, możesz bezpiecznie zignorować tę wiadomość." +
                "              </p>" +
