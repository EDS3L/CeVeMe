...
class ChangeUserEmailUseCaseTest {
    ...
    @Test
    void shouldChangeEmail_whenEmailIsAvailable() throws AccessDeniedException {
        // GIVEN
        long userId = 1L;
    ...
    @Test
    void shouldNotThrowException_whenEmailBelongsToSameUser() throws AccessDeniedException {
        // GIVEN
        long userId = 1L;
