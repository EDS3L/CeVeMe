...
import { User, Mail, Lock, MapPin, Phone, ArrowRight, Sparkles, CheckCircle } from "lucide-react";
...
const RegisterForm = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-kraft via-bookcloth to-manilla min-h-screen flex items-center justify-center font-sans p-4 relative overflow-hidden">
        ...
        <div className="bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/30 p-8 md:p-10 space-y-6">
          ...
          <form className="space-y-5" onSubmit={handleRegister}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <label htmlFor="surname" className="block text-sm font-semibold text-white/90">
                  Nazwisko
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label htmlFor="city" className="block text-sm font-semibold text-white/90">
                  Miasto
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div className="space-y-2">
                <label htmlFor="phoneNumber" className="block text-sm font-semibold text-white/90">
                  Telefon
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    onChange={(e) => setPhoneNumber(extractNationalDigits(e.target.value))}
